<?php
//ไฟล์ backend/ApproveDocument-ApproveDocument-IndustrialEducationDean.php
...
try {
    ...
    // เพิ่มข้อมูลลงตาราง deanfiesign
    $sqlInsert = "INSERT INTO deanfiesign (id_teacher, deanfiesign_nameDocs, deanfiesign_IdDocs, deanfiesign_nameDeanIndEdu, deanfiesign_description, deanfiesign_sign, deanfiesign_status) 
    VALUES (?, ?, ?, ?, ?, ?, ?)";
    $stmtInsert = $conn->prepare($sqlInsert);
    if (!$stmtInsert)
        throw new Exception("Error preparing INSERT SQL: " . $conn->error);

    $status = "ได้รับการอนุมัติจากคณบดีคณะครุศาสตร์อุตสาหกรรมแล้ว";
    ...
    $formsubmitStatus = "ได้รับการอนุมัติจากคณบดีคณะครุศาสตร์อุตสาหกรรม";
