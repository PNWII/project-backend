<?php
//ไฟล์นี้ใช้สำหรับดึงข้อมูลเอกสารทั้งหมดที่ส่งเข้ามาจากฟอร์ม โดยไม่ต้องใช้ status ในการตรวจสอบ และส่งข้อมูลกลับในรูปแบบ JSON
...
try {
    ...
    $stmt = $conn->prepare("
        ...
        LEFT JOIN 
            ...
            AND f.formsubmit_type = 'คคอ. บว. 11 แบบขอเสนอโครงการวิทยานิพธ์/การศึกษาค้นคว้าอิสระ'
        LEFT JOIN 
