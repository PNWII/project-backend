...
try {
    ...
    $projectApprovalDate = $input['projectApprovalDate'] ?? null;
    $gs13projectApprovalDocument = $input['gs13projectApprovalDocument'] ?? null;
    $gs16OfficeGraduationApprovalReport = $input['gs16OfficeGraduationApprovalReport'] ?? null;
    $gs16OfficeThesisCertificateDoc = $input['gs16OfficeThesisCertificateDoc'] ?? null;
    $gs17OfficeMasterPlanOneApprovalDoc = $input['gs17OfficeMasterPlanOneApprovalDoc'] ?? null;
    $gs19OfficeMasterPlanTwoApprovalDoc = $input['gs19OfficeMasterPlanTwoApprovalDoc'] ?? null;
    $gs23OfficeThesisDocDate = $input['gs23OfficeThesisDocDate'] ?? null;
    $gs23OfficeCumulativeGPAStudent = $input['gs23OfficeCumulativeGPAStudent'] ?? null;
    $gs23OfficeKnowledgeExamPass = $input['gs23OfficeKnowledgeExamPass'] ?? null;
    ...
    if ($type === "คคอ. บว. 10 แบบขออนุมัติแต่งตั้งอาจารย์ที่ปรึกษาวิทยานิพนธ์/การศึกษาค้นคว้าอิสระ") {
        ...
        $statusGS10 = "ได้รับการอนุมัติจากเจ้าหน้าที่บัณฑิตศึกษาแล้ว";
        ...
        $statusGS12 = "ได้รับการอนุมัติจากเจ้าหน้าที่บัณฑิตศึกษาแล้ว";
        ...
        gradofficersignGs13_projectApprovalDocument
        ) VALUES (?, ?, ?, ?, ?, ?, ?,?)";
        ...
        $statusGS13 = "ได้รับการอนุมัติจากเจ้าหน้าที่บัณฑิตศึกษาแล้ว";
        ...
        $statusGS16 = "ได้รับการอนุมัติจากเจ้าหน้าที่บัณฑิตศึกษาแล้ว";
        ...
        $statusGS17 = "ได้รับการอนุมัติจากเจ้าหน้าที่บัณฑิตศึกษาแล้ว";
        ...
        $statusGS19 = "ได้รับการอนุมัติจากเจ้าหน้าที่บัณฑิตศึกษาแล้ว";
        ...
        $statusGS23 = "ได้รับการอนุมัติจากเจ้าหน้าที่บัณฑิตศึกษาแล้ว";
        ...
        $status = "ได้รับการอนุมัติจากเจ้าหน้าที่บัณฑิตศึกษาแล้ว";
    ...
    $formsubmitStatus = "ได้รับการอนุมัติจากเจ้าหน้าที่บัณฑิตศึกษา กำลังรอการพิจารณาจากรองคณบดีฝ่ายวิชาการและวิจัย";
